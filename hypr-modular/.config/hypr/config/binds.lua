...
-- Move window to a specific monitor. These are ALT, not SHIFT, because the
-- SUPER+SHIFT+[0-9] loop further down this file binds those to move-to-workspace
...
-- Focus a monitor directly. Left disabled: SUPER+[0-9] is taken by the
-- workspace loop below, and since each monitor owns a fixed block of
-- workspaces (see workspaces.lua), SUPER+1 / SUPER+5 / SUPER+8 already jump
-- to the Dell / ASUS / laptop respectively. Uncomment on free keys if wanted.
